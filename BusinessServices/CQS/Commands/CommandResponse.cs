...
namespace BusinessServices.CQS.Commands {
    ...
    /// </summary>
    public struct CommandResponse : IEquatable<CommandResponse>, IComparable<CommandResponse>, IComparable {
        /// <summary>
        /// Default and only value of the <see cref="CommandResponse"/> type.
        /// </summary>
        public static readonly CommandResponse Value = new CommandResponse();
        ...
        public static bool operator ==(CommandResponse first, CommandResponse second) {
            return true;
        }
